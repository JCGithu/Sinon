...
var _a = require('../utilities/utils.js'), lineBreak = _a.lineBreak, progressBar = _a.progressBar;
...
function audioConvert(convertInfo) {
                ...
                preConfirm: function (audioForm) {
                    ...
                    function convertTHATFILE() {
                        ...
                        if (i == convertInfo.targets.length) {
                            ...
                            console.log(i);
                            var finalOutput = convertInfo.targets[i].output + '.' + audioForm;
                            if (convertInfo.targets[i].ext.indexOf('.' + audioForm) >= 0 ||
