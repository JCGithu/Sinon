    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, axios
                    ...
                    var element, docs, docText;
                    return __generator(this, function (_a) {
                        element = document.getElementById('ver');
                        if (element.innerHTML !== response.data.version) {
                            element.style = 'color:var(--hover)';
                            docs = document.getElementById('documentation');
                            docText = "<h4 style=\"color:var(--hover)\">// Current version of Sinon is " + response.data.version + "</h4>" + docs.innerHTML;
...
module.exports = { docReady: docReady, lineBreak: lineBreak, progressBar: progressBar, swalColours: swalColours, copyString: copyString, URLwipe: URLwipe, versionChecker: versionChecker };
