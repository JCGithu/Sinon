...
function screengrabs(multi, swalColour, format, targetFiles) {
            ...
            return [2 /*return*/, new Promise(function (resolve) {
                    Swal.fire({
                        ...
                        preConfirm: function (grabNum) {
                            ...
                            numberGen(grabNum).then(function (stages) {
...
function numberGen(grabNum) {
    ...
    return new Promise(function (resolve) {
        for (var i = 0; i <= grabNum; i++) {
            var percent = Math.floor((100 / grabNum) * i);
            array.push(percent + "%");
            if (i == grabNum) {
                resolve(array);
            }
