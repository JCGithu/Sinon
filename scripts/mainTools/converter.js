...
var videoConvert = require('../converters/video.js');
var audioConvert = require('../converters/audio.js');
var gifConvert = require('../converters/gif.js');
var _a = require('../utilities/utils.js'), swalColours = _a.swalColours, lineBreak = _a.lineBreak;
function run_convert(targetFiles) {
    return __awaiter(this, void 0, void 0, function () {
        var convertFile, e, fileInfo, convertInfo;
        return __generator(this, function (_a) {
            ...
            targetFiles.forEach(function (targetFile) {
                var out = path.join(path.parse(targetFile).dir, path.parse(targetFile).name);
                var file = {
                    input: targetFile,
                    output: out,
