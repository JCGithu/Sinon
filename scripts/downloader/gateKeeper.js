...
function gateKeeper(input) {
    return new Promise(function (resolve) {
        ...
        var hostname = parse(input.URL).resource.replace('www.', '').split('.')[0];
        ...
        fs.readFile(path.resolve(__dirname, './websites.json'), function (err, data) {
            if (err)
                throw err;
...
function statusCheck(input) {
    return __awaiter(this, void 0, void 0, function () {
        var i, proxyInfo, proxyHost;
        var _this = this;
        return __generator(this, function (_a) {
            i = 0;
            proxyInfo = {};
            if (input.proxyUse == true) {
                proxyHost = input.proxy.split(':');
                proxyInfo = { proxy: {
                        host: proxyHost[0],
                        port: proxyHost[1]
                    } };
            ...
            return [2 /*return*/, axios.get(input.URL)
                    ...
                    return __generator(this, function (_a) {
                        if (response.status == 200) {
                            ...
                            if (i > 5 || useProxy == false) {
                                ...
                                proxyGenerator().then(function (newProxy) {
