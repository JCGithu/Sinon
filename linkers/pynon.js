                ...
                Swal.fire({
                    ...
                    preConfirm: (dlquality) => {
                        ...
                        if (finalURL.indexOf('.mp4') >= 0 || finalURL.indexOf('.mp3') >= 0) {
                            ...
                            (async () => {
                                try {
                                    await pipeline(got.stream(finalURL), fs.createWriteStream(downloadPath));
                                    successAlert('', '', swalColour);
                                }
                                catch (error) {
                                    errorAlert(error, 'download', '', swalColour);
                            ...
                            if (timing === 'clip') {
                                Swal.fire({
                                    ...
                                    preConfirm: (formValues) => {
                                        let startNumber = document.getElementById('swal-input1').value, endNumber = document.getElementById('swal-input2').value, start = '--start=' + startNumber, end = '--stop=' + endNumber;
                                        if (start !== "") {
                                            if (end !== "") {
                                                let iplayerArgs = [
                                                    '--force',
