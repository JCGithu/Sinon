...
async function run_effect(){
    ...
    if (format.indexOf('custom')>=0){
            Swal.fire({
                ...
                preConfirm: (async () => {
                    var custom_get = document.getElementById("custom_one") as HTMLSelectElement;
                    format = custom_get.options[custom_get.selectedIndex].value;
                    var custom_get = document.getElementById("custom_two") as HTMLSelectElement;
                    let custom_two = custom_get.options[custom_get.selectedIndex].value;
                    var custom_get = document.getElementById("custom_three") as HTMLSelectElement;
